...
function Product({ product }) {
    return (
        <Card className="my-3 p-3 text-white rounded shadow">
            <strong className="ct">{product.rating > 2 && product.numReviews > 0 ? <span class="badge badge-danger"><i class="fas fa-star"></i> TOP REVIEWED</span> : <br></br> }</strong>
